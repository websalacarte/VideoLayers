<?php
// Obtiene los datos acerca del video de Vimeo.
// Permite disponer de:
//		datos sobre el video (width, height, duration, ...)
//		datos del autor (imagen, nombre...)
//		compatibilidad del formato del video con los distintos navegadores posibles
// 		privacidad del video (si es público, privado, ...)
