...
/*
	...
	v1.2 	24-11-2017 		#488 en getStats get_video_comments_box obtenia solo la primera cifra porque tenia [0]. Eliminado el indice porque es un select count(*), ergo un numero, no un vector.
*/
?>
...
<?php 
	...
	*/
?>
<?php $videoId={video_id};	//73589408 Kevin Spacey (old: 22647358) // el id en nuestra BD ?>
<?php $platform_videoId='{platform_video_id}'; // el id en YT-Vimeo ?>
<?php $videoId_subt=24819045;	 ?>
<?php $page_id={new_page_id}; ?>
<?php 
	// v1.1
	$num_cats = {cat_num};
	$cat[0] = "{cat_1}";
...
<body>
	<div class="main_container">
		...
		<!-- CONTAINER -->
		<h2>{new_h3} - <span>{client_name}</span></h2>
		<div class="container">
			<div id="form">
