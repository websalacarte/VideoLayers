...
<?php 
	...
	*/
?>
<?php $videoId=35;	//73589408 Kevin Spacey (old: 22647358) // el id en nuestra BD ?>
...
<head>
	<title>Ucrania por Ricardo Marquina</title>
...
<body class="is_overlaid">
	<div class="main_container">
		...
		<!-- CONTAINER -->
		<h2>Ucrania por Ricardo Marquina - <span>JosepFB</span></h2>
		<div class="container">
			<div id="form">
						...
						<div id="idioma" class="subs_selector">
							<div id="subchooser" class="subchooser">
								<form name="subselect" class="form" action="">            
									...
									<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_1" VALUE="1" onchange="show_comments('subs_1')" checked ><label for="subs_1">Escena</label></div>
									<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_2" VALUE="2" onchange="show_comments('subs_2')" checked ><label for="subs_2">Dialogo</label></div>
									<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_3" VALUE="3" onchange="show_comments('subs_3')" checked ><label for="subs_3">Ð¡Ñ†ÐµÐ½Ð°</label></div>
									<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_4" VALUE="4" onchange="show_comments('subs_4')" checked ><label for="subs_4">Ð”Ð¸Ð°Ð»Ð¾Ð³</label></div>
