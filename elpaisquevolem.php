...
<?php 
	...
	*/
?>
<?php $videoId=19;	//73589408 Kevin Spacey (old: 22647358) // el id en nuestra BD ?>
<?php $platform_videoId= "'" . 3y3r3ts6Rzc . "'"; // el id en YT-Vimeo ?>
<?php $videoId_subt=24819045;	 ?>
<?php $page_id=25; ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>Constitucio</title>
...
<?php include_once("header_template.php"); ?>
	...
	<!-- CONTAINER -->
	<h2>LA CONSTITUCIÃ“ DE LA CATALUNYA INDEPENDENT - <span>JaneDoe</span></h2>
	<div class="container">
		<div id="form">
			...
			<div id="idioma" class="subs_selector">
				<div id="subchooser" class="subchooser">
					<form name="subselect" class="form" action="">            
						...
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_1" VALUE="1" onchange="show_comments('subs_1')" checked ><label for="subs_1">constituciÃ³</label></div>
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_2" VALUE="2" onchange="show_comments('subs_2')" checked ><label for="subs_2">El paÃ­s que volem</label></div>
        ...
        player.stopVideo();
			...
			<div id="area_comentarios">
				...
				<div id="comentarios_<?php echo $videoId; ?>_1" class="caja_comentarios wrapper">
					<div class="page-data">constituciÃ³</div>				
...
<!--							<div id="comment-post-btn_<?php echo $videoId; ?>_1" class="comment-post-btn comment-post-btn-wrapper">Post
				...
				<div id="comentarios_<?php echo $videoId; ?>_2" class="caja_comentarios wrapper">
					<div class="page-data">El paÃ­s que volem</div>				
					<div class="comment-wrapper">
