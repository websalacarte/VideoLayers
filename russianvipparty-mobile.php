...
<?php 
	...
	*/
?>
<?php $videoId=4;	//73589408 Kevin Spacey (old: 22647358) ?>
<?php $video_platform_Id='89292050';	?>
<?php $videoId_subt=24819045;	 ?>
<?php $page_id=4; ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>Russian VIP Party</title>
<?php include_once("head_common-mobile.php"); ?>
...
<?php include_once("header_template.php"); ?>
	...
	<!-- CONTAINER -->
	<h2>Russian VIP Party - <span>Video Layers</span></h2>
	...
	<div class="container">
		<div id="form">
			...
			<object id="video-0" width="800" height="350" rel="<?php echo $videoId; ?>">
				...
				<param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id=<?php echo $videoId; ?>&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=1&amp;color=00adef&amp;fullscreen=1&amp;width=800&amp;height=350" />
				<embed src="http://vimeo.com/moogaloop.swf?clip_id=<?php echo $videoId; ?>&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=1&amp;color=00adef&amp;fullscreen=1&amp;width=800&amp;height=350" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="800" height="350">
				</embed>
			</object>
			-->
			<iframe id="video-0" src="http://player.vimeo.com/video/<?php echo $video_platform_Id; ?>?api=1&amp;player_id=video-0" width="800" height="350" frameborder="0"></iframe>
