<?php
/*
	v1.1 	22-11-2017 		cambio estilos (comments-layout-small.css) -> head_common-youtube -> head_common-youtube-small.php
*/
?>
...
<?php 
	...
	*/
?>
<?php $videoId=54;	//73589408 Kevin Spacey (old: 22647358) // el id en nuestra BD ?>
<?php $platform_videoId='wX3BsqdtDE8'; // el id en YT-Vimeo ?>
<?php $videoId_subt=24819045;	 ?>
<?php $page_id=60; ?>
<?php 
	// v1.1
	$num_cats = 4;
	$cat[0] = "Acerca de videolayers";
	$cat[1] = "CategorÃ­as";
	$cat[2] = "Comentarios";
	$cat[3] = "Acciones";
	$cat[4] = "{cat_5}";
...
<head>
	<title>Videolayers sobre videolayers</title>
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css">
	<?php include_once("head_common-youtube-small.php"); ?>
...
<body>
	<div class="main_container">
		...
		<!-- CONTAINER -->
		<h2>Videolayers - <span>JosepFB</span></h2>
		<div class="container">
			<div id="form">
						...
						<div id="idioma" class="subs_selector">
							<div id="subchooser" class="subchooser">
								<form name="subselect" class="form" action="">            
									<p><label for="subs">Escull els temes que t'interessin:</label>
							...
							<div id="idioma" class="subs_selector">
								<div id="subchooser" class="subchooser">
									<form name="subselect" class="form" action="">            
										...
										<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_1" VALUE="1" onchange="show_comments('subs_1')" checked ><label for="subs_1">Acerca de videolayers</label></div>
										<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_2" VALUE="2" onchange="show_comments('subs_2')" checked ><label for="subs_2">CategorÃ­as</label></div>
										<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_3" VALUE="3" onchange="show_comments('subs_3')" checked ><label for="subs_3">Comentarios</label></div>
										<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_4" VALUE="4" onchange="show_comments('subs_4')" checked ><label for="subs_4">Acciones</label></div>
			      	...
			      	// This code loads the YT IFrame Player API code asynchronously.
						...
						*/
						...
						function onPlaying() {
							...
							revisa_comments = requestAnimationFrame(function(){check_comments()});	
							...
							//sigue_onPlaying = setInterval(function(){onPlaying()},1000);	
								...
								if (isDefined(refresh_slider_slots)) {
									...
									for (var i_cajita = 1; i_cajita <= num_cajas; i_cajita++){
										...
										//console.log('sigue_refreshing con caja: '+i_cajita+' curr_time_value: '+curr_time_value);
										...
										//sigue_refreshing_slider[aux_cajita] = requestAnimationFrame(function(){refresh_slider(aux_cajita, 0)});
										refresh_slider(aux_cajita, 0);
										//sigue_refreshing_slider_slots[aux_cajita] = requestAnimationFrame(refresh_slider_slots(aux_cajita, 0, curr_time_value, video_duration));
									}
									//sigue_refreshing_slider_slots = setInterval(function(){refresh_slider_slots()},1000 / 60);
								}
							sigue_onPlaying = requestAnimationFrame(function(){onPlaying()});
						...
						function onPlayerStateChange(event) {
							...
							//  done = true;
								...
								sigue_onPlaying = requestAnimationFrame(function(){onPlaying()});
								//sigue_onPlaying = requestAnimationFrame(onPlaying());
								/*
								if (isDefined(refresh_slider_slots)) {
									curr_time_value = player.getCurrentTime();
					                video_duration = player.getDuration();
							...
							if (event.data == YT.PlayerState.PAUSED && !done) {
								...
								cancelAnimationFrame(revisa_comments);
								//clearInterval(sigue_onPlaying);
								cancelAnimationFrame(sigue_onPlaying);
								//if (sigue_refreshing_slider_slots) {
								if (sigue_refreshing_slider) {
									for (var i_cajita = 1; i_cajita <= num_cajas; i_cajita++){
										var aux_cajita = i_cajita;	// por delayed, i_cajita==5 !
										//clearInterval(sigue_refreshing_slider_slots[aux_cajita]);
										//cancelAnimationFrame(sigue_refreshing_slider_slots[i_cajita]);
										cancelAnimationFrame(sigue_refreshing_slider[i_cajita]);
									}
								}
							}
						}
				...
				<?php
					for($categ_i = 0; $categ_i < $num_cats; $categ_i++) {
						$cat_name = $categ_i + 1;
				?>	
					<div id="comentarios_<?php echo $videoId; ?>_<?php echo $cat_name; ?>" class="caja_comentarios wrapper">
						<div class="page-data"><?php echo $categ_title[$cat_name]; ?></div>				
						<div class="comment-wrapper container">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#llegir_<?php echo $cat_name; ?>" data-toggle="tab"><i class="fa fa-eye"></i><span>Llegir</span></a></li>
								<li><a href="#crear_<?php echo $cat_name; ?>" data-toggle="tab"><i class="fa fa-plus"></i><span>Crear</span></a></li>
							</ul>
	...
	<script>
		...
		*/
		...
		function refresh_slider_slots (i_caja, i_comment, curr_time_value, video_duration) {
		    ...
		    // divido el slider en franjas de 20seg (separacion_franjas), 
			...
			//sigue_refreshing_slider_slots[i_caja] = requestAnimationFrame(function(){refresh_slider_slots(i_caja, 0, curr_time_value, video_duration)});
			...
			$("#zoom_" + i_caja_zoom + '_' + i_comment_zoom +" .zoom_btn").on("click", function (e) {
				...
				refresh_slider_slots (i_caja_zoom, i_comment_zoom, curr_time_value, video_duration);
								...
								function refresh_slider(i_caja, i_comment) {
					                ...
					                //sigue_refreshing_slider[i_caja] = requestAnimationFrame(function(){refresh_slider(i_caja, 0)});
