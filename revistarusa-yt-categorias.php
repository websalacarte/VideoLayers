						...
						<!--<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_0" VALUE="none" onchange="show_comments('subs_none')" ><label for="subs_none">sin cajas</label></div>-->
									...
									<div class="btn-group" data-toggle="buttons">
										<label class="btn btn-default active">
											<input type="checkbox" name="subs" id="subs_1" value="1" onchange="show_comments('subs_1')" checked > кто есть кто <span class="badge">
										...
										<label class="btn btn-default active">
											<input type="checkbox" name="subs" id="subs_2" value="2" onchange="show_comments('subs_2')" checked > Quien es quien <span class="badge"><?php $num_comms_box = get_video_comments_box($videoId, 2); echo(  $num_comms_box[0] ); ?></span>
										</label>
										<label class="btn btn-default active">
											<input type="checkbox" name="subs" id="subs_3" value="3" onchange="show_comments('subs_3')" checked > Who is who <span class="badge"><?php $num_comms_box = get_video_comments_box($videoId, 3); echo(  $num_comms_box[0] ); ?></span>
										</label>
										<label class="btn btn-default active">
											<input type="checkbox" name="subs" id="subs_4" value="4" onchange="show_comments('subs_4')" checked > Sponsors only <span class="badge"><?php $num_comms_box = get_video_comments_box($videoId, 4); echo(  $num_comms_box[0] ); ?></span>
										</label>
									</div>
