...
<?php 
	...
	*/
?>
<?php $videoId=31;	//73589408 Kevin Spacey (old: 22647358) // el id en nuestra BD ?>
<?php $platform_videoId='ZFZ5h95vWG0'; // el id en YT-Vimeo ?>
<?php $videoId_subt=24819045;	 ?>
<?php $page_id=37; ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>Ucrania: El año del Caos - de Ricardo Marquina Montañana</title>
<?php include_once("head_common-youtube_subtitles.php"); ?>
...
var duracion_max_video = 805;	//13*60 + 25;
...
<?php include_once("header_template.php"); ?>
	...
	<!-- CONTAINER -->
	<h2>El año del Caos (de Ricardo Marquina Montañana) - <span>editing subtitles</span></h2>
	<div class="container">
		<div id="form">
						...
						<div id="idioma" class="subs_selector">
							<div id="subchooser" class="subchooser">
								<form name="subselect" class="form" action="">            
									...
									<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_2" VALUE="2" onchange="show_comments('subs_2')" checked ><label for="subs_2">Arabic subtitles</label></div>
						...
						<div id="save_file">
							...
							<table class="dwnld_subt">
								...
								<tr>
									...
									<td><a href="save_subt.php?subt=en&f=vtt" target="_new"><i class="fa fa-download"></i>Engl VTT</a></td>
									<td><a href="save_subt.php?subt=en&f=srt" target="_new"><i class="fa fa-download"></i>Engl SRT</a></td>
								</tr>
								<tr>
									<td>Russian subtitles</td>
									<td><a href="save_subt.php?subt=ru&f=vtt" target="_new"><i class="fa fa-download"></i>Russ VTT</a></td>
									<td><a href="save_subt.php?subt=ru&f=srt" target="_new"><i class="fa fa-download"></i>Russ SRT</a></td>
								</tr>
							</table>
						</div>
      ...
      function onYouTubeIframeAPIReady() {
        ...
        player = new YT.Player('player_yt', {
          height: '390',									// pendiente obtención desde API youtube durante validación
          width: '640',
          videoId: 'ZFZ5h95vWG0',
          events: {
        ...
        player.stopVideo();
			...
			<div id="area_comentarios">
				...
				<div id="comentarios_<?php echo $videoId; ?>_1" class="caja_comentarios wrapper">
					<div class="page-data">English subtitles</div>				
				...
				<div id="comentarios_<?php echo $videoId; ?>_2" class="caja_comentarios wrapper">
					<div class="page-data">Russian subtitles</div>				
					<div class="comment-wrapper">
