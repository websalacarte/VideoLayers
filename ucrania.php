...
<?php 
	...
	*/
?>
<?php $videoId=32;	//73589408 Kevin Spacey (old: 22647358) // el id en nuestra BD ?>
<?php $platform_videoId=164218427; // el id en YT-Vimeo ?>
...
<head>
	<title>Ucrania</title>
<?php include_once("head_common-hanaa.php"); ?>
...
#area_comentarios .comments-list .btn_clock {
    margin: 25px 5px 5px 5px;	/* para dejar espacio al botÛn delete, comments-list porque sÛlo es en los nuevos subtÌtulos */
}
...
var duracion_max_video = 5316;	//4*60 + 54;	1h 28m 36 = 3600 + 1680 + 36 = 5316
var tiempo_slr_cajas = [];
var coger_tiempo_slr = [];
var coger_tiempo_slr_editpost = [];

var tiempo_slr_cajas_post = [[]];
var coger_tiempo_slr_post = [[]];	// dejarÈ de usarlo. SÛlo necesito el post.
var coger_tiempo_slr_editpost = [];	// lo inicializarÈ 
var tiempo_slr_cajas_post = [];
for(var x = 0; x < 100; x++){
...
console.log('clicado btn_clock. caja: ' + caja + ', edit_comm_id: ' + edit_comm_id + ', caja_tmp length: ' + caja_tmp.length);
		...
		// inicializamos, pero sÛlo si no existe ya.
		...
		if( caja_tmp.length == 3 ) {
			...
			if ( $( "#clock_slr_" + caja + "_" + edit_comm_id ).is(":visible") ) {
				// aÒado class 'isvisible' para estilar timeBtn y cambiar su tooltip title
...
<?php include_once("header_template.php"); ?>
	...
	<!-- CONTAINER -->
	<h2>Ucrania: el a√±o del caos - <span>por Ricardo Marquina Monta√±ana</span></h2>
	<div class="container">
		<div id="form">
			...
			<div id="idioma" class="subs_selector">
				<div id="subchooser" class="subchooser">
					<form name="subselect" class="form" action="">            
						...
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_1" VALUE="1" onchange="show_comments('subs_1')" checked ><label for="subs_1">English</label></div>
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_2" VALUE="2" onchange="show_comments('subs_2')" checked ><label for="subs_2">–†—É—Å—Å–∫–∏</label></div>
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_3" VALUE="3" onchange="show_comments('subs_3')" checked ><label for="subs_3">–£–∫—Ä–∞—ó–Ω—Å—å–∫–æ—é</label></div>
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_4" VALUE="4" onchange="show_comments('subs_4')" checked ><label for="subs_4">Castellano</label></div>
			...
			<!-- 
			<object id="video-0" width="800" height="350" rel="<?php echo $platform_videoId; ?>">
				<param name="allowfullscreen" value="true" />
				<param name="allowscriptaccess" value="always" />
				<param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id=<?php echo $platform_videoId; ?>&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=1&amp;color=00adef&amp;fullscreen=1&amp;width=800&amp;height=350" />
				<embed src="http://vimeo.com/moogaloop.swf?clip_id=<?php echo $platform_videoId; ?>&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=1&amp;color=00adef&amp;fullscreen=1&amp;width=800&amp;height=350" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="800" height="350">
				</embed>
			</object> 
			-->
			...
			<div id="my_video">
				<div id="my_video_iframe">
					<iframe id="video-0" src="http://player.vimeo.com/video/<?php echo $platform_videoId; ?>?api=1&player_id=video-0#t=0" width="640" height="360" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>


						<div id="my_video_playingcontrols">
							<!--<button>Play</button> <button>Pause</button>-->
							<div id="seeks">
								<button class="seek">Back -5s <input type="hidden" value="5" size="3" maxlength="3" /></button>
				...
				<div id="my_video_edit">
						...
						<div id="idioma" class="subs_selector">
							<div id="subchooser" class="subchooser">
								<form name="subselect" class="form" action="">            
									<h6 class="actions">Check the subtitles you want to view/edit:</h6>
									...
									<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_1" VALUE="1" onchange="show_comments('subs_1')" checked ><label for="subs_1">English subtitles</label></div>
									<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_2" VALUE="2" onchange="show_comments('subs_2')" checked ><label for="subs_2">Russian subtitles</label></div>
						...
						<div id="save_file">
							<h6 class="actions">Download subtitles file</h6>
							<!--
							<a href="save_subt.php?subt=en" target="_new"><p>Download subtitles in <b>English</b> for Vimeo (vtt file)</p></a>
							<a href="save_subt.php?subt=ar" target="_new"><p>Download subtitles in <b>Arabic</b> for Vimeo (vtt file)</p></a>
							-->
							<table class="dwnld_subt">
								<tr>
									<th>&nbsp;</th>
									<th>VTT</th>
									<th>SRT</th>
								...
								<tr>
									...
									<td><a href="save_subt_ucrania.php?subt=en&f=vtt" target="_new"><i class="fa fa-download"></i>EN VTT</a></td>
									<td><a href="save_subt_ucrania.php?subt=en&f=srt" target="_new"><i class="fa fa-download"></i>EN SRT</a></td>
								</tr>
								<tr>
									<td>Russian subtitles</td>
									<td><a href="save_subt_ucrania.php?subt=ru&f=vtt" target="_new"><i class="fa fa-download"></i>RU VTT</a></td>
									<td><a href="save_subt_ucrania.php?subt=ru&f=srt" target="_new"><i class="fa fa-download"></i>RU SRT</a></td>
								</tr>
							</table>
						</div>
			...
			<div id="area_comentarios">
				...
				<div id="comentarios_<?php echo $videoId; ?>_1" class="caja_comentarios wrapper">
					<div class="page-data">English</div>				
					<div class="comment-wrapper">
						<h6 class="new_subtitles_header">Current subtitles:</h6>
						<div class="comments-list">
							<ul id="comments-holder-ul_<?php echo $videoId; ?>_1" class="comments-holder-ul">
								...
								?>
								<?php require (INC . 'comment_box_new.php'); ?>
							</ul>
						</div>
						...
						<h6 class="new_subtitles_header">Create new subtitle</h6>
						<div class="comment-insert">
							...
							<div id="comment-post-btn_<?php echo $videoId; ?>_1" class="comment-post-btn_con_slr comment-post-btn-wrapper">Insert new subtitle
							</div>
				...
				<div id="comentarios_<?php echo $videoId; ?>_2" class="caja_comentarios wrapper">
					...
					<div class="comment-wrapper">
						...
						<div class="comment-insert">
							...
							<div id="comment-post-btn_<?php echo $videoId; ?>_2" class="comment-post-btn_con_slr comment-post-btn-wrapper">Insert new subtitle
							</div>
						</div>
...
var video_duration;
var curr_time_value;
//var clockSlider = [[]];	// clockSlider[i_caja][num_comentario] es el clockslider de cada comentario en la p·gina. inicialmente, sÛlo 2 (1 para cada "comentario 0").
...
function update_clock_inputs (i_caja, i_comment, values, handle, fecha_formato_lectura) {
	...
	document.getElementById('clock-slider-val-'+clock_input+'-milis_'+i_caja+'_'+i_comment).value = num_milis;
			...
			function refresh_slider_slots (i_caja, i_comment, curr_time_value, video_duration) {
	                            ...
	                            // ej: dur_video < 20s (1 slot), curr_time: 11s --> Ant: 0, Curr: 0, Next: 3 --> Ranges: (0, min(20,60))						// atencion: limitar a duraciÛn
...
function anyade_evento_zoom(i_caja_zoom, i_comment_zoom) {
	// evento para zoom_cajai_commi aÒadido (lo aÒado con id porque el resto ya tienen el evento)
