...
<?php 
	...
	*/
?>
<?php $videoId=18;	//73589408 Kevin Spacey (old: 22647358) // el id en nuestra BD ?>
<?php $platform_videoId="'".XhUnWae2UM8."'"; // el id en YT-Vimeo ?>
<?php $videoId_subt=24819045;	 ?>
<?php $page_id=24; ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>VideoLayers Demo at YT</title>
...
<?php include_once("header_template.php"); ?>
	...
	<!-- CONTAINER -->
	<h2>VideoLayers demo at Youtube - <span>JohnSmith</span></h2>
	<div class="container">
		<div id="form">
			...
			<div id="idioma" class="subs_selector">
				<div id="subchooser" class="subchooser">
					<form name="subselect" class="form" action="">            
						...
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_1" VALUE="1" onchange="show_comments('subs_1')" checked ><label for="subs_1">Catalan</label></div>
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_2" VALUE="2" onchange="show_comments('subs_2')" checked ><label for="subs_2">Spanish</label></div>
						...
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_4" VALUE="4" onchange="show_comments('subs_4')" checked ><label for="subs_4">Italian</label></div>
        ...
        player.stopVideo();
			...
			<div id="area_comentarios">
				...
				<div id="comentarios_<?php echo $videoId; ?>_1" class="caja_comentarios wrapper">
					<div class="page-data">Catalan</div>				
...
<!--							<div id="comment-post-btn_<?php echo $videoId; ?>_1" class="comment-post-btn comment-post-btn-wrapper">Post
				...
				<div id="comentarios_<?php echo $videoId; ?>_4" class="caja_comentarios wrapper">
					<div class="page-data">Italian</div>				
					<div class="comment-wrapper">
						<!--<h3 class="comment-title">Introduce un nuevo comentario</h3>-->
