...
<body class="is_overlaid is_commsallover ">
	...
	<style>
		.is_overlaid.is_commsallover #new_comms_wrapper {
		...
		.is_overlaid.is_commsallover #new_comm_content {
			display: block;
			position: absolute;
		    top: 10px;
		    left: 10px;
	...
	<script>
		...
		$(function() {
			...
			*/
		    ...
		    $("#new_comment_button").on('click touchstart', function() {
		    	...
		    	var new_handle_comentario = '<div id="new_comms_wrapper" class="new_comms_wrapper caja_comentarios wrapper ui-widget-content"><div id="'+id_new_comm+'" class="comm_handle"><a><i class="fa fa-user-o"></i></a></div><div id="new_comm_content" class="new_comm_content"></div></div>';	// despues, tras insert DB, borrare este wrapper
		    	area_comentarios.append(new_handle_comentario);
		    	...
		    	$("#new_comms_wrapper").draggable({containment: "#area_comentarios", scroll: false, stop: posiciona_nuevo_comentario()} );	//({ handle: ".comm_handle" });	//$(".comm_handle").draggable({ handle: "a" });
		...
		*/
		...
		function inserta_comentario_flotante() {
			...
			var mi_nuevo_comm_username = "Pep";
			var mi_nuevo_comm_categ_name = 5;
			var mi_nuevo_comm_videoId = 5;
