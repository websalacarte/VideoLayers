...
$filename="hanaa/subtitles_".$subtitles_caja.".".$fichero_ext;
...
require_once('includes/ficheros_hanaa.php');	// necesito nombre del video
...
include('includes/get_subtitles.php');
