			...
			<div id="form">
				...
				<div id="idioma" class="subs_selector">
					<div id="subchooser" class="subchooser">
						<form name="subselect" class="form" action="">            
							...
							<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_1" VALUE="1" onchange="show_comments('subs_1')" checked ><label for="subs_1">descripciÃ³ personatge</label></div>
							...
							<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_3" VALUE="3" onchange="show_comments('subs_3')" checked ><label for="subs_3">actuaciÃ³ actriu</label></div>
							<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_4" VALUE="4" onchange="show_comments('subs_4')" checked ><label for="subs_4">props i direcciÃ³</label></div>
										...
										<div class="columna_botones">
											<div class="btn-group btn-block" data-toggle="buttons">
												<label class="btn btn-default btn-block active">
													<input type="checkbox" name="subs" id="subs_1" value="1" onchange="show_comments('subs_1')" checked > descripciÃ³ personatge <span class="badge">
											...
											<div class="btn-group btn-block" data-toggle="buttons">
												<label class="btn btn-default btn-block active">
													<input type="checkbox" name="subs" id="subs_2" value="2" onchange="show_comments('subs_2')" checked > altres personatges <span class="badge">
															<?php 
																$num_comms_box = get_video_comments_box($videoId, 2);   
																//echo( '<script>console.log("num_comms_box: ' . $num_comms_box . '");</script>' ); 
																if(is_numeric($num_comms_box[0])) {
																	echo(  $num_comms_box[0] );
																}
											...
											<div class="btn-group btn-block" data-toggle="buttons">
												<label class="btn btn-default btn-block active">
													<input type="checkbox" name="subs" id="subs_3" value="3" onchange="show_comments('subs_3')" checked > actuaciÃ³ actriu <span class="badge">
															<?php 
																$num_comms_box = get_video_comments_box($videoId, 3);  
																//echo( '<script>console.log("num_comms_box: ' . $num_comms_box . '");</script>' ); 
																if(is_numeric($num_comms_box[0])) {
																	echo(  $num_comms_box[0] );
																}
											...
											<div class="btn-group btn-block" data-toggle="buttons">
												<label class="btn btn-default btn-block active">
													<input type="checkbox" name="subs" id="subs_4" value="4" onchange="show_comments('subs_4')" checked > props i direcciÃ³ <span class="badge">
															<?php 
																$num_comms_box = get_video_comments_box($videoId, 4);  
																//echo( '<script>console.log("num_comms_box: ' . $num_comms_box . '");</script>' ); 
																if(is_numeric($num_comms_box[0])) {
																	echo(  $num_comms_box[0] );
																}
				...
				<div id="area_comentarios">
					...
					<div id="comentarios_<?php echo $videoId; ?>_1" class="caja_comentarios wrapper">
						<div class="page-data">descripciÃ³ personatge</div>				
					...
					<div id="comentarios_<?php echo $videoId; ?>_3" class="caja_comentarios wrapper">
						<div class="page-data">actuaciÃ³ actriu</div>				
						<div class="comment-wrapper container">
							<ul class="nav nav-tabs">
					...
					<div id="comentarios_<?php echo $videoId; ?>_4" class="caja_comentarios wrapper">
						<div class="page-data">props i direcciÃ³</div>				
						<div class="comment-wrapper container">
							<ul class="nav nav-tabs">
	...
	<script>
		...
		*/
		...
		$(".zoom_btn").on("click", function (e) {
			...
			//if ($button.text() == "+") {
			if ($button.hasClass("zoom_plus")) {		// era zoom_plus (o minus)
