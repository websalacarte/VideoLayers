<?php
/*
	v1.1 	22-11-2017 		cambio estilos (comments-layout-small.css) -> head_common-hanaa -> head_common-hanaa-small.php
...
<?php $video_platform_Id={platform_video_id}; // el id en YT-Vimeo ?>
