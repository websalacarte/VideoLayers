...
var MidityVimeoLib = {
    ...
    initialize: function(){
        ...
        console.log('Midity initialized');
    },
    ...
    replace: function(embedObject){
        ...
        console.log('Midity replaced ...\n      1: '+parsedURI["page"]+', \n      2: MidityVimeo_'+ parsedURI["options"]["clip_id"]+', \n      3: '+width+', \n      4: '+height+', \n      7: '+JSON.stringify(flashvars)+', \n      8: '+JSON.stringify(params)+', \n      9: '+JSON.stringify(attributes));
        console.log('Midity replaced (id: '+parsedURI["options"]["clip_id"]+')');
    },
    ...
    loaded: function(swf_id){
        ...
        console.log('Midity loaded (MidityVimeo_' + swf_id+')');
    },
    ...
    onPlaying: function(time, clip_id){
        /* TODO: review code */
        //console.log('onPlaying, con time: '+time+', last_refresh: '+last_refresh_time);		
        console.log('onPlaying, tiempo actual (pre): '+tiempo_actual_play+', time (Midity): '+time);
