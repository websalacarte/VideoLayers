...
<?php 
	...
	*/
?>
<?php $videoId=12;	//73589408 Kevin Spacey (old: 22647358) // el id en nuestra BD ?>
<?php $platform_videoId="'".vpYqygdftls."'"; // el id en YT-Vimeo ?>
<?php $videoId_subt=24819045;	 ?>
<?php $page_id=17; ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>Truby demo</title>
<?php include_once("head_common-youtube3.php"); ?>
...
<?php include_once("header_template.php"); ?>
	...
	<!-- CONTAINER -->
	<h2>Truby demo (2) - <span>Websalacarte</span></h2>
	<div class="container">
		<div id="form">
			...
			<div id="idioma" class="subs_selector">
				<div id="subchooser" class="subchooser">
					<form name="subselect" class="form" action="">            
						<p><label for="subs">Choose the subjects<br />you are interested in:</label>
						...
						<!--
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_1" VALUE="1" onchange="show_comments('subs_1')" checked ><label for="subs_1">Story</label></div>
						...
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_3" VALUE="3" onchange="show_comments('subs_3')" checked ><label for="subs_3">Camera</label></div>
						<div class="checks"><INPUT TYPE="checkbox" NAME="subs" id="subs_4" VALUE="4" onchange="show_comments('subs_4')" checked ><label for="subs_4">World</label></div>
						-->
								<div class="columna_botones">
									<div class="btn-group btn-block" data-toggle="buttons">
										<label class="btn btn-default btn-block active">
											<input type="checkbox" name="subs" id="subs_1" value="1" onchange="show_comments('subs_1')" checked > Story <span class="badge">
											 <!-- getNumCommentsVideoBox ($video, $box) desde getStats.php -->
											 <?php 
											 $num_comms_box = get_video_comments_box($videoId, 1); 
									...
									<div class="btn-group btn-block" data-toggle="buttons">
										<label class="btn btn-default btn-block active">
											<input type="checkbox" name="subs" id="subs_2" value="2" onchange="show_comments('subs_2')" checked > Characters <span class="badge"><?php $num_comms_box = get_video_comments_box($videoId, 2); echo(  $num_comms_box[0] ); ?></span>
										</label>
									</div>
									<div class="btn-group btn-block" data-toggle="buttons">
										<label class="btn btn-default btn-block active">
											<input type="checkbox" name="subs" id="subs_3" value="3" onchange="show_comments('subs_3')" checked > Camera <span class="badge"><?php $num_comms_box = get_video_comments_box($videoId, 3); echo(  $num_comms_box[0] ); ?></span>
										</label>
									</div>
									<div class="btn-group btn-block" data-toggle="buttons">
										<label class="btn btn-default btn-block active">
											<input type="checkbox" name="subs" id="subs_4" value="4" onchange="show_comments('subs_4')" checked > World <span class="badge"><?php $num_comms_box = get_video_comments_box($videoId, 4); echo(  $num_comms_box[0] ); ?></span>
										</label>
									</div>
								</div>
        ...
        player.stopVideo();
			...
			<div id="area_comentarios">
				...
				<div id="comentarios_<?php echo $videoId; ?>_1" class="caja_comentarios wrapper">
					<div class="page-data"><span id="btn_comm_insert_1" class="btn_comm_insert">Story&nbsp;<i class="btn_comm_insert_fa fa fa-angle-down"></i></span></div>				
					<div class="comment-wrapper">
						
						<!--<h3 class="comment-title">Introduce un nuevo comentario</h3>-->
						
						<div id="comment-insert_1" class="comment-insert">
...
<!--							<div id="comment-post-btn_<?php echo $videoId; ?>_1" class="comment-post-btn comment-post-btn-wrapper">Post
				...
				<div id="comentarios_<?php echo $videoId; ?>_2" class="caja_comentarios wrapper">
					<div class="page-data"><span id="btn_comm_insert_2" class="btn_comm_insert">Characters&nbsp;<i class="btn_comm_insert_fa fa fa-angle-down"></i></span></div>				
					<div class="comment-wrapper">
						
						<!--<h3 class="comment-title">Introduce un nuevo comentario</h3>-->
						
						<div id="comment-insert_2" class="comment-insert">
							<h3 class="who-says"><span>Says:</span> <?php echo $log_uname; //$userName; ?></h3>
							<div class="edit_post">
				...
				<div id="comentarios_<?php echo $videoId; ?>_3" class="caja_comentarios wrapper">
					<div class="page-data"><span id="btn_comm_insert_3" class="btn_comm_insert">Camera&nbsp;<i class="btn_comm_insert_fa fa fa-angle-down"></i></span></div>
					<div class="comment-wrapper">
						
						<!--<h3 class="comment-title">Introduce un nuevo comentario</h3>-->
						
						<div id="comment-insert_3" class="comment-insert">
							<h3 class="who-says"><span>Says:</span> <?php echo $log_uname; //$userName; ?></h3>
							<div class="edit_post">
...
$(document).ready(function() {
	$( ".comment-insert" ).hide();
	$( ".btn_comm_insert" ).click( function(){
		$( this ).find( ".btn_comm_insert_fa" ).toggleClass( "fa-angle-down" ).toggleClass( "fa-angle-up" );
		// averigua id
		$( this ).parents( ".caja_comentarios" ).find( ".comment-insert" ).slideToggle("slow", function() {	
			// display -> none
			// Animation complete.
		});	
	});
				...
				<div id="comentarios_<?php echo $videoId; ?>_4" class="caja_comentarios wrapper">
					<div class="page-data"><span id="btn_comm_insert_4" class="btn_comm_insert">World&nbsp;<i class="btn_comm_insert_fa fa fa-angle-down"></i></span></div>
					<div class="comment-wrapper">
						<!--<h3 class="comment-title">Introduce un nuevo comentario</h3>-->
						
						<div id="comment-insert_4" class="comment-insert">
							<h3 class="who-says"><span>Says:</span> <?php echo $log_uname; //$userName; ?></h3>
							<div class="edit_post">
	...
	<div class="footer-demo" style="height: 100px;">&nbsp;</div>
	<!-- END CONTAINER -->
