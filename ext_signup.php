...
if(isset($_POST['displayName'])){
	...
	try{
		...
		$from = "From: JPG @ Websalacarte <info@websalacarte.com>";
		$subject = "Activate your VideoLayers account";
		$link = 'http://www.websalacarte.com/videolayers/v0.7/last_step.php?user='.$lastId.'&token='.$token.'';
		//// Start Email Body ////
		$message = "
Thanks for registering an account at VideoLayers! We are glad you decided to join us in this adventure.
...
";
		...
		$headers .= "From: $fromrn";
		/// Send the email now ////
		mail($email, $subject, $message, $headers, '-f info@websalacarte.com');
