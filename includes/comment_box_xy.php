...
/*
	...
	1.3 			17-12-2017 		"comment_box_xy.php". Anyado posicionamiento (x,y) a cada comentario, y (w,h).
*/
?>
...
<li class="comment-holder comms_wrapper" id="_<?php echo($comment->comment_id); ?>" data-timein="<?php echo($comment->time_in); ?>" data-timeout="<?php echo($comment->time_out); ?>" 
...
style="display: none; " >
	<div id="comm_handle_<?php echo $videoId; ?>_<?php echo $comment->box_id; ?>_<?php echo $comment->comment_id; ?>" class="comm_handle" style="display: none;">
		<a><i class="fa fa-user-o"></i></a>
	</div>
	<div id="comm_content_<?php echo $videoId; ?>_<?php echo $comment->box_id; ?>_<?php echo $comment->comment_id; ?>" class="comm_content">
		<div class="user-img">
