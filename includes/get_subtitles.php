...
<?php require_once('includes/ficheros_hanaa.php'); ?>
<?php //include_once("scripts/check_user.php"); ?>
<?php include_once("scripts/connect.php"); ?>
<?php 
$videoId=27;
$platform_videoId=142343354; // el id en YT-Vimeo
...
//$subtitles_formato = "vtt" or "srt";
	...
	//echo ('<script>console.log("debug comment: ' . $comment->debug . ', debug user: ' . $user->debug . '")</script>');	
				...
				*/
				...
				$output_conBR = html_entity_decode( html_entity_decode( removeslashes($comment->comment), ENT_QUOTES), ENT_QUOTES);
